...
(lazy-init
 ...
 ;;** smart parenthesis matching a minor mode for Emacs that deals with
 ;;** parens pairs and tries to be smart about it.
 (show-smartparens-global-mode t)
 (smartparens-global-mode t)

 ;;** integration with paredit mode
 ...
 (sp-local-pair 'org-mode "/" "/" :actions '(wrap))
 (sp-local-pair 'org-mode "*" "*" :actions '(wrap))
 (sp-local-pair 'go-mode "{" nil :post-handlers '((custom-newline-and-enter-sexp "RET")))
 (defun custom-newline-and-enter-sexp (&rest _ignored)
 ...
 (eval-after-load 'js2-mode '(sp-local-pair 'js2-mode "<" ">"))
 (eval-after-load 'html-mode '(sp-local-pair 'html-mode "<" ">"))
